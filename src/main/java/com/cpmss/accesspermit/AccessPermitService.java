...
import com.cpmss.accesspermit.dto.AccessPermitResponse;
import com.cpmss.accesspermit.dto.CreateAccessPermitRequest;
import com.cpmss.accesspermit.dto.UpdateAccessPermitRequest;
import com.cpmss.common.PagedResponse;
import com.cpmss.contract.Contract;
import com.cpmss.contract.ContractRepository;
...
public class AccessPermitService {
     ...
     * @throws com.cpmss.exception.BusinessException if entitlement rule is violated
     */
    @Transactional
