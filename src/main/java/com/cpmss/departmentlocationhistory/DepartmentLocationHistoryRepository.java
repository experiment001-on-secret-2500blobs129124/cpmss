package com.cpmss.departmentlocationhistory;
 ...
 * methods for SCD Type 2 location lookups.
 */
public interface DepartmentLocationHistoryRepository
    ...
    /**
     * Finds all location history entries for a department, ordered by date descending.
     *
     * @param departmentId the department's UUID
     * @return location history entries, most recent first
     */
    List<DepartmentLocationHistory> findByDepartmentIdOrderByStartDateDesc(UUID departmentId);
}
